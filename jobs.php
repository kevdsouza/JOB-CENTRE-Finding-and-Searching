...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href=""  class="citySearch" data-target="Thane"><i class="fa fa-circle-o text-yellow"></i> Thane </a></li>
                      <li><a href=""  class="citySearch" data-target="Chennai"><i class="fa fa-circle-o text-yellow"></i> Chennai </a></li>
                      <li><a href=""  class="citySearch" data-target="Banglore"><i class="fa fa-circle-o text-yellow"></i> Banglore </a></li>
                      <li><a href=""  class="citySearch" data-target="San Jose"><i class="fa fa-circle-o text-yellow"></i> San Jose </a></li>
                  ...
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href="" class="experienceSearch" data-target='9'><i class="fa fa-circle-o text-yellow"></i> > 9 Years</a></li>
                      <li><a href="" class="experienceSearch" data-target='10'><i class="fa fa-circle-o text-yellow"></i> > 10 Years</a></li>
                      <li><a href="" class="experienceSearch" data-target='11'><i class="fa fa-circle-o text-yellow"></i> > 11 Years</a></li>
                      <li><a href="" class="experienceSearch" data-target='12'><i class="fa fa-circle-o text-yellow"></i> > 12 Years</a></li>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018 <a href="https://www.instagram.com/kevin_dsouza/">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
