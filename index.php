    ...
    <section id="candidates" class="content-header">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/car1.jpeg" alt="Apply & Get Interviewed">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="images/car.jpg" alt="Start A Career">
              <div class="caption">
    ...
    <section id="company" class="content-header">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="img/interviewed.jpg" alt="Apply & Get Interviewed">
              <div class="caption">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>
            This Website has been created by the joint efforts of Mr. Kevin Dsouza and Ms. Zainab Khokhawala usinh php and Mysql.
            Copyrighted in 2018, this website serves as a project givem to us by TCS, India.
            </p>
            <p>
